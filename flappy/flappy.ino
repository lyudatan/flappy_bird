...
#define SKIP_TICKS     23.0     // 1000 / 50fps
...
void game_start() {
  ...
  TFT.fillRect(10, TFTH2 - 20, TFTW-20, 1, ST7735_GREEN);
  TFT.fillRect(10, TFTH2 + 32, TFTW-20, 1, ST7735_GREEN);
  ...
  TFT.println("Arduino");
  TFT.setCursor( TFTW2 - (12*3) - 1, TFTH2 + 40);
...
void game_over() {
  ...
  TFT.setTextSize(2);
  // half width - num char * char width in pixels
  TFT.setCursor( TFTW2 - (9*6), TFTH2 - 18);
  TFT.println("GAME OVER");
  TFT.setTextSize(1);
  TFT.setCursor( 36, TFTH2 +2);
  TFT.print("Score: ");
  TFT.print(score);
  //TFT.setCursor( TFTW2 - (12*3), TFTH2 + 16);
  //TFT.println("press button");
   delay(2500);
  while (1) {
